...
//When ever Exam will be a submit result will be showing
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/mypic.jpeg" width=150 height=120 alt="Vaibhav Sapate" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://www.linkedin.com/in/akanksha-thotwe-0ab495326" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on LinkedIn">Vaibhav Sapate
  </a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+918766020927</h4>
		<h4 style="font-family:'typo' ">vaibhavsapate23@gmail.com</h4>
		<h4 style="font-family:'typo' ">Dr. G.Y.Pathrikar College of Computer Science and Information Technology, Chh. Sambhajinagar</h4></div></div>
		</p>
      </div>
